        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <img src={logo} alt="Gurudatta Foodtek Solutions" className="w-12 h-12 object-contain bg-white rounded-lg p-1" />
              <div>
                <h3 className="text-xl">Gurudatta Foodtek Solutions</h3>
                <p className="text-sm text-[#FFFFF2]/80">Processing Solutions</p>
              </div>
            </div>
            <p className="text-[#FFFFF2]/80 mb-4">
              Leading manufacturer of high-quality food processing equipment with over 25 years of industry experience.
            </p>
            <div className="space-y-2">
              ...
              <div className="flex items-start gap-2 text-sm">
                ...
                <span>S No 184, Bhosari Alandi Road, Banacha Odha, Near Govind Garden, Bhosari, Pune-411039, Maharashtra, India</span>
              </div>
            </div>
          </motion.div>
